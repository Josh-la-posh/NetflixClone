                    ...
                    <main>
                                    ...
                                    <div className="header__form-content">
                                        ...
                                        <div>
                                            <div className='label' htmlFor="email">
                                                <button className="" type='submit'><span>Get Started</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <section className="story-card">
                            <div className="story-card__container">
                                <div className="story-card__text">
                                    ...
                                    <h2 className="story-card__subtitle">Watch on Smart TVs, Playstation, Xbox, Chromecast, Apple TV, Blu-ray players, and more.</h2>
                                </div>
                                <div className="story-card__img">
                                    <div className="story-card__animation__container">
                                        <img src="https://assets.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/tv.png" alt="" className="story-card__img" />
                        ...
                        <section className="story-card">
                            <div className="story-card__container reverse">
                                <div className="story-card__text">
                                    <h1 className="story-card__title">Download your shows to watch offline.</h1>
                                    <h2 className="story-card__subtitle">Save your favourites easily and always have something to watch.</h2>
                                </div>
                                <div className="story-card__img">
                                    <div className="story-card__animation__container-2">
                                        <img src="https://assets.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/mobile-0819.jpg" alt="" className="story-card__img" />
                        ...
                        <section className="story-card">
                            <div className="story-card__container">
                                <div className="story-card__text">
                                    ...
                                    <h2 className="story-card__subtitle">Stream unlimited movies and RV shows on your phone, tablet, laptop, and TV.</h2>
                                </div>
                                <div className=""></div>
                            </div>
                        </section>
                        ...
                        <section className="story-card">
                            <div className="story-card__container reverse">
                                <div className="story-card__text">
                                    <h1 className="story-card__title">Create profiles for kids.</h1>
                                    <h2 className="story-card__subtitle">Send kids on adventurs with their favorite characters in space made just for them-- free with your membership.</h2>
                                </div>
                                <div className="story-card__img">
                                    <div className="story-card__animation__container">
                                        <img src="https://occ-0-300-1168.1.nflxso.net/dnm/api/v6/19OhWN2dO19C9txTON9tvTFtefw/AAAABfpnX3dbgjZ-Je8Ax3xn0kXehZm_5L6-xe6YSTq_ucht9TI5jwDMqusWZKNYT8DfGudD0_wWVVTFLiN2_kaQJumz2iivUWbIbAtF.png?r=11f" alt="" className="story-card__img" />
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <div className="story-card story-faq">
                            <div className="">
                                ...
                                <ul className="faq-list">
                                    <li className="faq-list__item" onClick={(e)=>this.handleFaq(e)}>
                                    ...
                                    <li className="faq-list__item">
                                        <button className="faq-question" onClick={(e)=>this.handleFaq(e)}>
                                    ...
                                    <li className="faq-list__item">
                                        ...
                                        <div className="faq-answer closed">
                                            <span>Watch anywhere, anytime. Sign in with your Netflix account to watch instantly on the web at netflix.com from your personal computer or on any internet-connected device that offers the Netflix app, including smart TVs, smartphones, tablets, streaming media players and game consoles.
                                                ...
                                                ou can also download your favorite shows with the iOS, Android, or Windows 10 app. Use downloads to watch while you're on the go and without an internet connection. Take Netflix with you anywhere.
                                            </span>
                                        </div>
                                    </li>
                                    <li className="faq-list__item">
